                    ...
                    <div class="item pb-3">
                        <div class="list-card bg-white h-100 rounded overflow-hidden position-relative shadow-sm">
                           <div class="list-card-image">
                              ...
                              <img src="{{ asset('upload/client_images/' . $client->foto) }}" class="img-fluid item-img" style="width: 300px; height:200px;">
                              </a>
                           </div>
                           <div class="p-3 position-relative">
                              ...
                              <div class="list-card-badge">
                                 @if ($coupons)
                                    ...
                                    <small>{{ $coupons->discount }}65% off | Use Coupon {{ $coupons->coupon_name }}</small>
                                 @else
                                    <span class="badge badge-success">OFFER</span>
