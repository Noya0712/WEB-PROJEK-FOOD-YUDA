...
@php
    $products = App\Models\Product::where('client_id', $client->id)->limit(2)->get();
               ...
               <div class="row d-flex align-items-end">
                  <div class="col-md-8">
                     <div class="restaurant-detailed-header-left">
                        <img class="img-fluid mr-3 float-left" alt="osahan" src="{{ asset('upload/client_images/' . $client->foto) }}">
            ...
            <div class="row">
               <div class="col-md-8">
                  <div class="offer-dedicated-body-left">
                     <div class="tab-content" id="pills-tabContent">
                        ...
                        @php
                            $populers = App\Models\Product::where('status',1)->where('client_id',
                            $client->id)->where('most_populer',1)->orderBy('id','desc')->limit(5)->get();
                        @endphp
                                    ...
                                    <div class="mall-category-item">
                                       <a href="#">
                                          ...
                                          @if ($populer->discount_price == null)
                                            ...
                                            @else
                                            $<del>{{$populer->price}}</del> ${{$populer->price}}
                           ...
                           @php
                            $bestsellers = App\Models\Product::where('status',1)->where('client_id',
                            $client->id)->where('best_seller',1)->orderBy('id','desc')->limit(6)->get();
                            @endphp
                           ...
                           <div id="gallery" class="bg-white rounded shadow-sm p-4 mb-4">
                              <div class="restaurant-slider-main position-relative homepage-great-deals-carousel">
                                 <div class="owl-carousel owl-theme homepage-ad">
                                    ...
                                    <div class="item">
                                       <img class="img-fluid" src="{{ asset($galery->galery_img) }}">
                                       <div class="position-absolute restaurant-slider-pics bg-dark text-white">{{ $index + 1 }} of {{ $galerys->count() }} Photos</div>
                                    </div>
                                    @endforeach
                           ...
                           <div id="restaurant-info" class="bg-white rounded shadow-sm p-4 mb-4">
                              <div class="address-map float-right ml-5">
                                 <div class="mapouter">
                                    ...
                                    src="https://maps.google.com/maps?q=university%20of%20san%20francisco&t=&z=9&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe></div>
                                 </div>
                              </div>
               ...
               <div class="col-md-4">
				  ...
				  <div class="bg-white rounded shadow-sm text-white mb-4 p-4 clearfix restaurant-detailed-earn-pts card-icon-overlap">
                     ...
                     @else
                     <p class="mb-0">{{ $coupon->discount }}% off on orders above $99 | Use coupon
                        <span class="text-danger font-weight-bold">{{ $coupon->coupon_name }}</span></p>
                     @endif
                  ...
                  <div class="generator-bg rounded shadow-sm mb-4 p-4 osahan-cart-item">
                     ...
                     <div class="bg-white rounded shadow-sm mb-2">
                        ...
                        <div class="gold-members p-2 border-bottom">
                           <p class="text-gray mb-3 float-right ml-3">Rp{{ $details['price'] * $details['quantity'] }}</p>
