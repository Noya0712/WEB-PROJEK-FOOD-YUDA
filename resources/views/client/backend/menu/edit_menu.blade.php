            ...
            <div class="col-xl-9 col-lg-8">
                <div class="card">
                    ...
                    <div class="card-body p-4">
                        <form id="myFrom" action="{{ route('menu.update') }}" method="post" enctype="multipart/form-data">
                            @csrf
                                ...
                                <div class="col-lg-6">
                                    <div class="mt-3 mt-lg-0">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <img id="showImage" src="{{ asset($menu->image) }}" alt="" class="rounded-circle p-1 bg-primary" style="width: 100%; height: 100%; object-fit: cover;">
                                            </div>
                                        </div>
