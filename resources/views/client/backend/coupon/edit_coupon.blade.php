            ...
            <div class="col-xl-12 col-lg-8">
                <div class="card">
                    ...
                    <div class="card-body p-4">
                        <form id="myFrom" action="{{ route('coupon.update') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-6 col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input class="form-control" name="validity" type="date" id="example-text-input"
