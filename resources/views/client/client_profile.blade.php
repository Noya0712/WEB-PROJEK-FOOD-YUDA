                            ...
                            <div class="col-sm order-2 order-sm-1">
                                <div class="d-flex align-items-start mt-3 mt-sm-0">
                                    ...
                                    <div class="avatar-xl me-3" style="width: 100px; height: 100px; overflow: hidden; border-radius: 50%;">
                                        <img src="{{ (!empty($profileData->foto)) ? url('upload/client_images/'.$profileData->foto) : url('upload/profileXample.jpg') }}" alt="" class="img-fluid d-block" style="width: 100%; height: 100%; object-fit: cover;">
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        rows="2" placeholder="Enter your Text">{{ $profileData->shop_info }}</textarea>
                                    </div>
                                    ...
                                    <img id="showImage" src="{{ (!empty($profileData->cover_photo)) ? url('upload/client_images/'. 
                                    $profileData->cover_photo) : url('upload/profileXample.jpg') }}"
                                    alt="" class=" p-1 bg-primary" style="width: 200px; height: 100px;">
                            ...
                            <div class="col-lg-6">
                                <div class="mt-3 mt-lg-0">
                                    ...
                                    <div class="mb-3">
                                        <div class="avatar-xl me-3" style="width: 100px; height: 100px; overflow: hidden; border-radius: 50%;">
                                            <img id="showImage" src="{{ (!empty($profileData->foto)) ? url('upload/client_images/'.$profileData->foto) : url('upload/profileXample.jpg') }}"
