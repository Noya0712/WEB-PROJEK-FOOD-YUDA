                            ...
                            <div class="col-lg-6">
                                <div>
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control @error('old_password') id-invalid @enderror" name="old_password" type="password" id="old_password">
                                        @error('old_password')
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control @error('new_password') id-invalid @enderror" name="new_password" type="password" id="new_password">
                                        @error('new_password')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
