                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            <li>
                                <a href="javascript: void(0);" class="has-arrow">
                                    <i data-feather="grid"></i>
                                    <span data-key="t-apps">Galery</span>
                                </a>
                                <ul class="sub-menu" aria-expanded="false">
                                    <li>
                                        <a href="{{ route('all.galery') }}">
                                            <span data-key="t-calendar">All Galery</span>
                                        </a>
                                    </li>
        
                                    <li>
                                        <a href="{{ route('add.galery') }}">
                                            <span data-key="t-chat">Add Galery</span>
                                        </a>
                                    </li>
