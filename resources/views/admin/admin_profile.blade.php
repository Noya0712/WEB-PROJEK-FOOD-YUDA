                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="mt-3 mt-lg-0">
                                    ...
                                    <div class="mb-3">
                                        <div class="avatar-xl me-3" style="width: 100px; height: 100px; overflow: hidden; border-radius: 50%;">
                                            <img id="showImage" src="{{ (!empty($profileData->foto)) ? url('upload/admin_images/'.$profileData->foto) : url('upload/profileXample.jpg') }}" alt="" class="rounded-circle p-1 bg-primary" style="width: 100%; height: 100%; object-fit: cover;">
                                        </div>
                                    </div>
