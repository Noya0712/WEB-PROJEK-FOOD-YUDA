                                ...
                                <div class="d-flex align-items-start mt-3 mt-sm-0">
                                    <div class="flex-shrink-0">
                                        <div class="avatar-xl me-3" style="width: 100px; height: 100px; overflow: hidden; border-radius: 50%;">
                                            <img src="{{ (!empty($profileData->foto)) ? url('upload/admin_images/'.$profileData->foto) : url('upload/profileXample.jpg') }}" alt="" class="img-fluid d-block" style="width: 100%; height: 100%; object-fit: cover;">
                                        </div>
                                    </div>
