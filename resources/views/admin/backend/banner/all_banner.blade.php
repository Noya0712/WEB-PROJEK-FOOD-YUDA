                                    ...
                                    <div class="card-body">
                                        ...
                                        <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-primary waves-effect waves-light" 
                                                    data-bs-toggle="modal" data-bs-target="#myEdit" id="{{ $item->id }}" onclick="bannerEdit(this.id)" >Edit</button>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form id="myFrom" action="{{ route('banner.store') }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                        ...
                                        <div class="col-lg-12">
                                            <div>
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <img id="showImage" src="{{ url('upload/profileXample.jpg') }}" alt="" class="rounded-circle p-1 bg-primary" style="width: 100%; height: 100%; object-fit: cover;">
                                                    </div>
                                                </div>
                ...
                <div id="myEdit" class="modal fade" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true" data-bs-scroll="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                            <form id="myFrom" action="{{ route('banner.update') }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div>
                                                ...
                                                <div class="form-group mb-3">
                                                    <div class="avatar-xl me-3" style="width: 100px; height: 100px; overflow: hidden; border-radius: 50%;">
                                                    <img id="bannerImage" src="" alt="" class="rounded-circle p-1 bg-primary" style="width: 100%; height: 100%; object-fit: cover;">
                                                    </div>
                                                </div>
